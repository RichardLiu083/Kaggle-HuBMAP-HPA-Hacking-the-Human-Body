...
def cutmix_aug(img_size,
    ...
    cut_size= np.random.randint(10, int(img_1.shape[0])-10)
...
def mosaic_aug(img_size,
    ...
    ## choose center point
    center_point_x= np.random.randint( int(img_size*0.25), int(img_size*0.75) )
    center_point_y= np.random.randint( int(img_size*0.25), int(img_size*0.75) )
